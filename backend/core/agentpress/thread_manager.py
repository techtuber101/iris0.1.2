            ...
            while auto_continue and (native_max_auto_continues == 0 or auto_continue_count < native_max_auto_continues):
                ...
                try:
                    ...
                    try:
                        ...
                        if ("AnthropicException - Overloaded" in str(e) or 
                            "VertexAIException" in str(e) or 
                            "model is overloaded" in str(e).lower() or
                            "ServiceUnavailableError" in str(e) or
                            "MidStreamFallbackError" in str(e) or
                            "503" in str(e) or
                            ...
                            # Get the appropriate Gemini fallback
                            from core.services.llm import get_openrouter_fallback
                            fallback_model = get_openrouter_fallback(model_name_cleaned)
                            if fallback_model:
                                llm_model = fallback_model
                            else:
                                # Default to flash if no specific fallback found
